    ...
    try {
        ...
        switch (page) {
            ...
            case 'workouts':
                ...
                break;
            case 'plan4weeks':
                content = await loadPlan4WeeksPage();
                break;
            case 'running':
...
async function loadPlan4WeeksPage() {
    return `
        <div class="page plan-4-weeks-page">
            <div id="plan-4-weeks-container">
                <!-- Plan 4 semanas se renderiza desde plan-4-weeks.js -->
            </div>
        </div>
    `;
}
...
async function executePageScripts(page) {
    ...
    switch (page) {
        ...
        case 'workouts':
            ...
            break;
        case 'plan4weeks':
            if (window.initPlan4Weeks) window.initPlan4Weeks();
            break;
        case 'running':
